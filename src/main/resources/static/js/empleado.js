          ...
          if (data) {
            const contentModal = {
              ...
              body: `<div class="text-center">
                      ...
                      <div><strong>Apellido del empleado: </strong>${data.apellido}</div>
                      <div><strong>Telefono del empleado: </strong>${data.telefono}</div>
                      <div><strong>Dni del empleado: </strong>${data.dni}</div>
                      <div><strong>Fecha de registro del empleado: </strong>${data.fechaRegistro}</div>
                      <div><strong>Cargo del empleado: </strong>${data.cargo.nombre}</div>
                      <div><strong>Correo del empleado: </strong>${data.usuario.correo}</div>
										</div>`,
            ...
            const contentModal = {
             ...
             body: `<form class="d-flex flex-column gap-4" id="form-add" action="/configuracion/empleado/actualizar" method="POST">		
                ...
                <div class="row align-items-sm-center">
								...
								<div class="col-sm-7">
									<input class="form-control form-control-lg" type="text" id="name" name="nameEmpleado" value="${data.nombre}"/>
                ...
                <div class="row align-items-sm-center">
								...
								<div class="col-sm-7">
									<input class="form-control form-control-lg" type="text" id="name" name="lastnameEmpleado" value="${data.apellido}"/>
                ...
                <div class="row align-items-sm-center">
								...
								<div class="col-sm-7">
									<input class="form-control form-control-lg" type="text" id="name" name="dni" value="${data.dni}"/>
                ...
                <div class="row align-items-sm-center">
								...
								<div class="col-sm-7">
									<input class="form-control form-control-lg" type="text" id="name" name="correo" value="${data.usuario.correo}"/>
									<div id="name-invalid" class="text-start invalid-feedback">Introduce la categoría de plato correctamente. Mínimo 3 caracteres, máximo 20.</div>
								</div>
                </div>
                ...
                <div class="row align-items-sm-center">
								...
								<div class="col-sm-7">
									<input class="form-control form-control-lg" type="text" id="name" name="telefono" value="${data.telefono}"/>
									<div id="name-invalid" class="text-start invalid-feedback">Introduce la categoría de plato correctamente. Mínimo 3 caracteres, máximo 20.</div>
								</div>
                </div>
    ...
    const contentModal = {
      ...
      body: `<form class="d-flex flex-column gap-4" id="form-add" action="/configuracion/empleado/registrar" method="POST">		
                ...
                <div class="row align-items-sm-center">
								<label class="col-sm-5 fw-bold" for="name">Nombre:</label>
								<div class="col-sm-7">
									<input class="form-control form-control-lg" type="text" id="name" name="nameEmpleado" value=""/>
									<div id="name-invalid" class="text-start invalid-feedback">Introduce el nombre correctamente. Mínimo 3 caracteres, máximo 20.</div>
								</div>
                </div>
                ...
                <div class="row align-items-sm-center">
								<label class="col-sm-5 fw-bold" for="name">Apellido:</label>
								<div class="col-sm-7">
									<input class="form-control form-control-lg" type="text" id="name" name="lastnameEmpleado" value=""/>
									<div id="name-invalid" class="text-start invalid-feedback">Introduce el apellido correctamente. Mínimo 3 caracteres, máximo 20.</div>
								</div>
                </div>
                ...
                <div class="row align-items-sm-center">
								<label class="col-sm-5 fw-bold" for="name">DNI:</label>
								<div class="col-sm-7">
									<input class="form-control form-control-lg" type="text" id="name" name="dni" value=""/>
									<div id="name-invalid" class="text-start invalid-feedback">Introduce la categoría de plato correctamente. Mínimo 3 caracteres, máximo 20.</div>
								</div>
                </div>
                ...
                <div class="row align-items-sm-center">
								<label class="col-sm-5 fw-bold" for="name">Correo:</label>
								<div class="col-sm-7">
									<input class="form-control form-control-lg" type="text" id="name" name="correo" value=""/>
									<div id="name-invalid" class="text-start invalid-feedback">Introduce la categoría de plato correctamente. Mínimo 3 caracteres, máximo 20.</div>
								</div>
                </div>
                ...
                <div class="row align-items-sm-center">
								<label class="col-sm-5 fw-bold" for="name">Telefono:</label>
								<div class="col-sm-7">
									<input class="form-control form-control-lg" type="text" id="name" name="telefono" value=""/>
									<div id="name-invalid" class="text-start invalid-feedback">Introduce la categoría de plato correctamente. Mínimo 3 caracteres, máximo 20.</div>
								</div>
                </div>
